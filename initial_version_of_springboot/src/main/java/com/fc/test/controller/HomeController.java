...
import com.fc.test.request.sys.RegisterRequest;
...
public class HomeController extends BaseController{
	...
	public ModelAndView register(RegisterRequest registerRequest, String code, RedirectAttributes redirectAttributes, Model model, HttpServletRequest request) {
		ModelAndView view =new ModelAndView();
		String scode = (String)request.getSession().getAttribute(Constants.KAPTCHA_SESSION_KEY);
		//判断验证码
		view.setViewName("redirect:/login");
